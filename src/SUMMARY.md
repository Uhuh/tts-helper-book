...
- [Initial Setup](./pages/initial-setup/initial-setup.md)
  ...
  - [History / Queue](./pages/initial-setup/history-queue.md)
...
- [OpenAI (ChatGPT)](./pages/chat-gpt/openai-intro.md)
  - [ChatGPT Chat Settings](./pages/chat-gpt/openai-chat-settings.md)
